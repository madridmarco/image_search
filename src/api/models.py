...
from api.utils.engine.mysql import EngineMySql
from api.assets.credentials import credentials
from api.utils.sql.start_query import read_query
import base64
...
class GetData():
    ...
    def __init__(self):
        ...
        self.db.run_query(query=read_query('create_pictures.sql'), dql= False)
        self.db.run_query(query=read_query('create_tags.sql'), dql= False)
